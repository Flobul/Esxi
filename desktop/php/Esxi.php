...
<div class="row row-overflow">
	<div class="col-lg-2 col-md-3 col-sm-4">
		<div class="bs-sidebar">
			<ul id="ul_eqLogic" class="nav nav-list bs-sidenav">
				<a class="btn btn-default eqLogicAction" style="width : 100%;margin-top : 5px;margin-bottom: 5px;" data-action="add"><i class="fa fa-plus-circle"></i> {{Ajouter Esxi}}</a>
	...
	<div class="col-lg-10 col-md-9 col-sm-8 eqLogicThumbnailDisplay" style="border-left: solid 1px #EEE; padding-left: 25px;">
		...
		<legend><i class="fa fa-bolt"></i>  {{Mes Esxis}}</legend>
		<div class="eqLogicThumbnailContainer">
			<?php
				foreach ($eqLogics as $eqLogic) {
				$opacity = '';
				...
				echo "<center>";
				echo '<img src="plugins/Esxi/plugin_info/esxi_icon.png" height="105" width="95" />';
				echo "</center>";
				...
				<div class="row">
					<div class="col-xs-8">
						...
						<div class="form-group">
							<label class="col-md-4 control-label">{{Nom de l'équipement Esxi}}</label>
							<div class="col-md-8">
